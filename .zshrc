...
alias gga="git add ."
alias ggprev="git checkout @{-1}"
alias uneo="uranus && code . && yarn start:neo-backend"
alias ulegacy="uranus && yarn start:legacy-backend"
export PATH=/home/$USER/.config/nvcode/utils/bin:$PATH
alias wtfidid="git log --branches --author=Kacper"
eval $(thefuck --alias)
